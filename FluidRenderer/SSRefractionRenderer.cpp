...
void SSRefractionRenderer::render(const ITextureObject& depthTexture, const ITextureObject& normalTexture, const ICamera& renderedCamera, const CubeMapTextureObject& cubeMapTexture)
{
	...
	const auto& mat = renderedCamera.getProjectionMatrix();
	glUniformMatrix4fv(shader.getUniformLocation("projectionMatrix"), 1, GL_FALSE, &mat[0][0]);
